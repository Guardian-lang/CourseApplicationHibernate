...
public class AuthorAttributesValidator {
    private static final AuthorAttributesValidator INSTANCE = new AuthorAttributesValidator();

    public static AuthorAttributesValidator getInstance() {
        return INSTANCE;
    }
